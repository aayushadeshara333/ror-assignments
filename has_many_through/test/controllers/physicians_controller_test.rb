...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference("Physician.count") do
      post physicians_url, params: { physician: { email: @physician.email, name: @physician.name, uniq_id: @physician.uniq_id } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { email: @physician.email, name: @physician.name, uniq_id: @physician.uniq_id } }
